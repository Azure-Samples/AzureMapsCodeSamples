/**
* List of External Azure Maps Samples.
...
var externalSamples = {
    ...
    //],
    //'Mobile': [
    //    { title: 'BingMapAndroid', href: 'https://github.com/LeonidVeremchuk/BingMapAndroid', description: 'An native Android SDK that wraps the Bing Maps V8 control.' }
    //],
    //'Other': [
    //    { title: 'DCProperties', href: 'https://github.com/rkgeorge/DCProperties', description: 'Example using Bing Maps v8 SpatialMath Module with the District of Columbia GIS services' }
    //],
    //'Desktop': [
