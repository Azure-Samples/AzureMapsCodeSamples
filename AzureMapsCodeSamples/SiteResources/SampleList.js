...
},
{
	...
	samples: [
		...
		{
			title:'Category legend options',
			desc:'This sample shows how the different options of the category legend type.',
			path:'Controls/Category%20legend%20options.html',
			sourcePath:'Controls/Category%20legend%20options.html',
			screenshot:'Category-legend-options.jpg',
			keywords:'microsoft maps, maps, map, api, sdk, gis, legend, legend control',
			created:'10/5/2021'
		},
		{
			title:'Create a layer control',
			desc:'This sample loads Mapbox styles of a GeoJSON polygon into Azure Maps.',
			path:'Controls/Create%20a%20layer%20control.html',
			sourcePath:'Controls/Create%20a%20layer%20control.html',
			screenshot:'Create-a-layer-control.jpg',
			keywords:'microsoft maps, maps, map, api, sdk, gis, layer control',
			created:'10/5/2021'
		},
		{
			title:'Create a legend control',
			desc:'TThis sample shows how to create a legend control and add it to the map.',
			path:'Controls/Create%20a%20legend%20control.html',
			sourcePath:'Controls/Create%20a%20legend%20control.html',
			screenshot:'Create-a-legend-control.jpg',
			keywords:'microsoft maps, maps, map, api, sdk, gis, legend, legend control',
			created:'10/5/2021'
		},
		{
			title:'Create HTML legend',
			desc:'This sample shows how to create legends using custom HTML with the legend control.',
			path:'Controls/Create%20HTML%20legend.html',
			sourcePath:'Controls/Create%20HTML%20legend.html',
			screenshot:'Create-HTML-legend.jpg',
			keywords:'microsoft maps, maps, map, api, sdk, gis, legend, legend control',
			created:'10/5/2021'
		},
		{
		...
		},
		{
			...
			desc:'This sample shows how to create a custom styled legend using CSS.',
			path:'Controls/Custom%20styled%20legend.html',
			sourcePath:'Controls/Custom%20styled%20legend.html',
			screenshot:'Custom-styled-legend.jpg',
			keywords:'microsoft maps, maps, map, api, sdk, gis, legend, legend control',
			created:'10/5/2021'
		},
		{
			title:'Dynamic legend and layer controls',
			desc:'This sample shows how to create use the dynamic legend and layer controls.',
			path:'Controls/Dynamic%20legend%20and%20layer%20controls.html',
			sourcePath:'Controls/Dynamic%20legend%20and%20layer%20controls.html',
			screenshot:'Dynamic-legend-and-layer-controls.jpg',
			keywords:'microsoft maps, maps, map, api, sdk, gis, legend, legend control',
			created:'10/5/2021'
		},
		{
		...
		{
			title:'Gradient legend options',
			desc:'This sample shows how the different options of the gradient legend type.',
			path:'Controls/Gradient%20legend%20options.html',
			sourcePath:'Controls/Gradient%20legend%20options.html',
			screenshot:'Gradient-legend-options.jpg',
			keywords:'microsoft maps, maps, map, api, sdk, gis, legend, legend control',
			created:'10/5/2021'
		},
		{
			title:'Layer control options',
			desc:'This sample shows how the different options of the legend control change the user experience.',
			path:'Controls/Layer%20control%20options.html',
			sourcePath:'Controls/Layer%20control%20options.html',
			screenshot:'Layer-control-options.jpg',
			keywords:'microsoft maps, maps, map, api, sdk, gis, layer control',
			created:'10/5/2021'
		},
		{
			title:'Legend control options',
			desc:'This sample shows how the different options of the legend control change the user experience.',
			path:'Controls/Legend%20control%20options.html',
			sourcePath:'Controls/Legend%20control%20options.html',
			screenshot:'Legend-control-options.jpg',
			keywords:'microsoft maps, maps, map, api, sdk, gis, legend, legend control',
			created:'10/5/2021'
		},
		{
...
},
{
	...
	samples: [
		...
		},
		{
			...
			desc:'',
			path:'REST%20Services/Geolocation%20Sample.html',
